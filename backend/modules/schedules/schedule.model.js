...
class ScheduleModel {
  ...
  static async create(data) {
    ...
    const record = {
      ...
      vehicleId: data.vehicleId || 'TRK-101',
      vehicleNumber: data.vehicleId || 'TRK-101',
      staffId: data.staffId || data.assignedStaffId || 'usr_staff_001',
      staffName: data.staffName || data.assignedStaffName || 'Assigned Crew',
      assignedStaffId: data.staffId || data.assignedStaffId || 'usr_staff_001',
      assignedStaffName: data.staffName || data.assignedStaffName || 'Assigned Crew',
